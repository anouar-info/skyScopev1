...
import { telescope2 } from "../../assets";
const sidebar = () => {
 
  return (
   
    <div className=" h-full mx-2 mt-4 mb-8">
    <div className="sidebar pb-60 sticky top-2 gradient__card145 bg-opacity-20 backdrop-blur-lg h-full w-[3.35rem] overflow-hidden border rounded-3xl border-blue-900  hover:w-56 hover:shadow-lg">
      <div className="flex  flex-col justify-between pt-2 pb-6">
        <div>
        <div>
        <Link to="weather/Current">
          <img className="w-8 h-8 m-2" src={telescope2} alt="logo" />
        </Link>
      </div>
          <ul className="mt-6 space-y-2 tracking-wide">
            <li className="min-w-max">
              <div aria-label="dashboard" className="relative flex items-center space-x-4 bg-gradient-to-r from-sky-600 to-cyan-400 px-4 py-3 text-white">
                <svg className="-ml-1 h-6 w-6" viewBox="0 0 24 24" fill="none">
                  <path d="M6 8a2 2 0 0 1 2-2h1a2 2 0 0 1 2 2v1a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2V8ZM6 15a2 2 0 0 1 2-2h1a2 2 0 0 1 2 2v1a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2v-1Z" className="fill-current text-cyan-400 dark:fill-slate-600"></path>
                  <path d="M13 8a2 2 0 0 1 2-2h1a2 2 0 0 1 2 2v1a2 2 0 0 1-2 2h-1a2 2 0 0 1-2-2V8Z" className="fill-current text-cyan-200 group-hover:text-cyan-300"></path>
                  <path d="M13 15a2 2 0 0 1 2-2h1a2 2 0 0 1 2 2v1a2 2 0 0 1-2 2h-1a2 2 0 0 1-2-2v-1Z" className="fill-current group-hover:text-sky-300"></path>
                </svg>
                <Link to="/weather/home" className="-mr-1 font-medium">Home</Link>
              </div>
            </li>
            <li className="min-w-max">
              <div className="bg group flex items-center space-x-4 rounded-full px-4 py-3 text-gray-600">
                ...
                <Link to="/weather/forecast"  className="group-hover:text-gray-700">Forecast</Link>
              </div>
            </li>
            <li className="min-w-max">
              <p className="group flex items-center space-x-4 rounded-md px-4 py-3 text-gray-600">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                ...
                <Link to="/weather/articles" className="group-hover:text-gray-700">Articles</Link>
              </p>
            </li>
            <li className="min-w-max">
